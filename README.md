...
- GUI detection defaults now start at exposure `5000 us`, gain `8`, fps `56`, focus `0.325`, threshold `200`, circularity `0.2`, and no blob diameter limits. Focus and circularity are now fixed in the GUI/control flow.
