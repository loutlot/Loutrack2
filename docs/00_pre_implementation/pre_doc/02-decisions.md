...
`context/archive/response_to_decisions.md` の内容を反映した、2026-02-22時点の整理です。
...
詳細は `docs/00_pre_implementation/pre_doc/05-steamvr-output.md`。
...
PTP導入やlibcamera SyncMode等のメモは `docs/00_pre_implementation/pre_doc/06-pi-sync.md` にまとめました。
