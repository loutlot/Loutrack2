...
| Integration | mode transition, object gating, single-ray virtual | `tests/test_rigid_mode_transitions.py`, `tests/test_object_conditioned_gating.py` |
...
7. Phase 5: object-conditioned 2D gating。
8. Phase 6: subset RANSAC と weighted solve。
